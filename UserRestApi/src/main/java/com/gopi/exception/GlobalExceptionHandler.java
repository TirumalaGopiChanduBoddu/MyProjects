...
@ControllerAdvice
//ResponseEntityExceptionHandler -- > to customise the validation errors 
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorDetails> handleExceptionm(Exception exception , WebRequest webRequest)	{
		ErrorDetails errorDetails = new ErrorDetails(LocalDateTime.now() , exception.getMessage() ,webRequest.getDescription(false) ,"INTERNAl__SERVER__ERROR" );
